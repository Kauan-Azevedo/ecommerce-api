...
let paymentMethodsFromEnv = (_a = process.env.SEED_PAYMENT_METHODS) === null || _a === void 0 ? void 0 : _a.split(",").map((paymentMethod) => paymentMethod.trim());
function seedPaymentMethods() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const paymentMethod of paymentMethodsFromEnv) {
            yield (0, setup_1.createPaymentMethod)(paymentMethod);
        }
    });
}
